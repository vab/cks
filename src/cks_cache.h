/* cks_cache.h - CKS Key cache routines header file
...
int load_cache(PGconn *,struct d_linked_list **);
struct openPGP_pubkey * search_cache(struct d_linked_list *,char *fp);
int free_cache(struct d_linked_list **);
